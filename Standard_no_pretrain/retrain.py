...
if __name__ == "__main__":
    ...
    for task in ["Height", "Weight"]:
        tResults = pd.read_csv(f"../results/optuna.results.{task}.Standard_no_pretrain.csv")
        ...
        early_stop_callback = load(f"../results/Standard_no_pretrain.{task}.earlystopping.dump")
